...
beaumanoir.pictures.attach(io: file_beaumanoir, filename: 'beaumanoir.jpg', content_type: 'image/jpg')
...
wots.pictures.attach(io: file_wots, filename: 'wots.jpg', content_type: 'image/jpg')
...
cap_enfants.pictures.attach(io: file_cap_enfants, filename: 'cap_enfants.jpg', content_type: 'image/jpg')
